...
public class ScrimInsetsLinearLayout
extends LinearLayout {
    ...
    public ScrimInsetsLinearLayout(Context context, AttributeSet attributeSet) {
        ...
        ScrimInsetsLinearLayout.super.a(context, attributeSet, 0);
    }

    public ScrimInsetsLinearLayout(Context context, AttributeSet attributeSet, int n2) {
        super(context, attributeSet, n2);
        ScrimInsetsLinearLayout.super.a(context, attributeSet, n2);
    }
